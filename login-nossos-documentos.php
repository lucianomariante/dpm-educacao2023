            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 pr-lg-5">
                    ...
                    <div class="col-12 px-0 py-0">
                        <div class="row">
                           <div class="col-12 px-0 py-1 bg-azul-padrao round-corners10">
                            <div class="roboto-bold text-white pl-4 text-sub-title-26 text-center">NOSSOS DOCUMENTOS LEGAIS</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-0">
                        <div class="col-12 px-0 py-0 text-center">
                            <div class="row text-center">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-0 mb-1">
                                    <div class="roboto-bold text-lead-header text-sub-title-24" style="color: #F7931E">
                      ...
                      <div class="col-12 px-0 py-0">
                            <div class="row">
                                <div class="colxs-12 col-sm-12 col-md-12 col-lg-12 text-line-height-22 pt-0 text-center">
                                    <span class="roboto-regular text-gray-3" style="font-size:16px">Favor autenticar-se com seus Dados de Acesso (Usuário e Senha), acaso não possua, solicitamos que nos contate via telefone ou email </span>
                                </div>
                            </div>
                      </div>
                       ...
                       <div class="col-12 px-0 pt-0 pb-4">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-line-height-22 pt-1 text-center">
                                    <span class="roboto-bold text-sub-title-18 text-gray-3" style="color: #01548E">Telefone: (51) 3027.3400<br>
