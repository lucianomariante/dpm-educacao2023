...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="row" style="margin: 50px 0 -63px 0;">
            <div class="col-md-8 roboto-bold text-lead-header" style="padding-top: 60px">PRÓXIMOS CURSOS</div>
           <div class="col-md-4" style="z-index: 999"><a href="https://www.dpmeducacao.com.br/ead/login.php" target="_blank"><img src="imgs/chamada_lateral.png"  style="width: 100%" alt=""/></a></div>
                ...
                <div class="col-md-4" style="display: flex">
                  <div class="blog-grid-simple" style="margin: 0 0 0px 0; min-height: 295px; border: solid 1.5px #dedede;">
                    ...
                    <div class="courses-grid-content">
                      ...
                      <?php endif; ?>
                      <?php if ($item['CURVAGAS'] - $item['CURMATRICULADOS'] > 0) : ?>
                      <a href="/cursos/<?= $item['CURCODIGO']; ?>"><button style="width: 100%; font-size: 12px; margin: 0 0 4px 0" class="btn btn-primary">
                      INSCREVA-SE
                      </button></a>
                      <?php endif; ?>
                      ...
                      <?php endif; ?>
                      <a href="/cursos/<?= $item['CURCODIGO']; ?>"><button style="width: 100%; font-size: 12px; margin: 0 0 4px 0; background-color: #8e8e8e; color: white;" class="btn btn-gray"   style="background-color: #045071" role="button">
                       SOBRE O CURSO
                      </button></a>
                    </div>
                  </div>
