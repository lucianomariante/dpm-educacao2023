                    ...
                    <div class="card-items bg-beige-theme space-between">
                      ...
                      <div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-12 pt-0 pb-0 pl-1">
                          ...
                          <span class="date roboto-regular">
                          <?= formatar_data($item['CURDATAINICIO']); ?>
                          </span> <span class="date roboto-regular">
                          <?= formatar_data($item['CURDATAFIM']); ?>
                          </span>
                          <?php } else { ?>
                          <span class="date roboto-regular">
                          <?= formatar_data($item['CURDATAINICIO']); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-1 pb-2 mb-2 pl-1 text-line-height-11"> <span class="city text-margin-left-8 roboto-regular">
                          <?= $item['CIDDESCRICAO']; ?>
                          </span> </div>
                        <div>
                          ...
                          <a class="btn button-link raleway-bold mt-1" style="background-color: #b9030f !important;" role="button">lotado</a> <a class="raleway-bold btn btn-blue text-uppercase btn-sm rounded-0  mt-1" href="cursos/lista-espera/<?= $item['CURCODIGO']; ?>"  style="background-color: #6f737e !important;">Lista de espera</a> <a class="btn button-link raleway-bold mt-1" href="cursos/<?= $item['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
                          <p class="text-sub-title-10" style="background-color: #5b88a5">(Inscrições abertas)</p>
                          </a> <a class="btn button-link raleway-bold mt-1" href="cursos/<?= $item['CURCODIGO']; ?>" style="background-color: #045071" role="button" role="button">sobre o curso</a>
                          <?php else : ?>
                          <a class="btn button-link raleway-bold mt-1" style="background-color: #b9030f !important;" role="button">lotado</a> <a class="raleway-bold btn btn-blue text-uppercase btn-sm rounded-0  mt-1" href="cursos/lista-espera/<?= $item['CURCODIGO']; ?>"  style="background-color: #6f737e !important;">Lista de espera</a> <a class="btn button-link raleway-bold mt-1" href="cursos/<?= $item['CURCODIGO']; ?>" style="background-color: #045071" role="button">sobre o curso</a>
                          <?php endif; ?>
                          <?php else : ?>
                          <a class="btn button-link raleway-bold mt-1" href="identificacao-acesso/<?= $item['CURCODIGO']; ?>"style="background-color: #f59330" role="button">Inscreva-se Aqui</a> <a class="btn button-link raleway-bold mt-1" href="cursos/<?= $item['CURCODIGO']; ?>" style="background-color: #045071" role="button">sobre o curso</a>
                          <?php endif; ?>
                          <?php endif; ?>
                          ...
                          </a> <a class="btn button-link raleway-bold mt-1" href="cursos/<?= $item['CURCODIGO']; ?>"style="background-color: #045071" role="button">sobre o curso</a> 
