...
// envioEmail("teste UBISTART", "teste 6", "ronerhenry@gmail.com", NIL);
...
function emailCabecalho($pSTitulo) {
	...
	$vSTexto .= '<img src="'.cSUrlSiteEmpresa.'imgs/'.cSLogoMarca.'" width="145px" height="auto" alt="" style="max-width: 200px; max-height: 80px;" data-cms-node="3">';
	$vSTexto .= '</th>';
...
function emailRodape() {
	...
	$vSTexto .= '    Email: <strong data-cms-node="18"> '.CFGEMAILRECEBIMENTO.'</strong>';
	$vSTexto .= '    </p>';
	$vSTexto .= '</td>';
	$vSTexto .= '</tr>';
	$vSTexto .= '</tfoot>';
