				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					...
					<div>
						<div class="box-float box-inscreva bg-blue-theme text-white-theme box-floating large-visible quando dont-show">
							...
							<?php endif; ?>
							<!-- <h3 class="roboto-bold-italic text-sub-title-24">Onde?</h3> -->
							<p class="roboto-regular text-sub-title-17  text-justify"><?= nl2br(strip_tags($curso['CURLOCALSITE'], '<b><strong>')); ?></p>
							...
							<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
								<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
									<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" style="background-color: #b9030f !important;" role="button">lotado</a>
									<a class="raleway-bold btn btn-accept btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>"style="background-color: #5b88a5" role="button">Nova Turma </br>
										<p class="text-sub-title-10 fonteBranca">(Inscrições abertas)</p>
									</a>
								<?php else : ?>
									<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" style="background-color: #b9030f !important;" role="button">lotado</a>
									<a class="raleway-bold btn btn-blue btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" href="cursos/lista-espera/<?= $curso['CURCODIGO']; ?>" style="background-color: #6f737e !important;">Lista de espera</a>
								<?php endif; ?>
							<?php else : ?>
								<!--<a class="raleway-bold btn btn-block rounded-0 button-link bg-orange-theme text-white-theme text-uppercase text-sub-title-16  mb-1" href="identificacao-acesso/<?= $curso['CURCODIGO']; ?>"  style="background-color: #f59330" role="button">Inscreva-se Aqui</a>-->
							<?php endif; ?>
						<?php endif; ?>
						<?php if ($curso['INSCRICOESEADATIVA'] == 'true') : ?>
							...
							<?php if ($curso['CURAOVIVO'] == 'true') : ?>
								<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
									<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
										<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" style="background-color: #b9030f !important;" role="button">lotado</a>
										<a style="color: white" class="raleway-bold btn btn-accept btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>"style="background-color: #5b88a5" role="button">Nova Turma </br>
						...
						<?php endif; ?>
							...
							<?php if ($curso['INSCRICOESEADATIVA'] == 'false') : ?>
								<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
									<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
										<!--<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" style="background-color: #b9030f !important;" role="button">lotado</a>
										<a class="raleway-bold btn btn-accept btn-sm rounded-0r mt-1 text-uppercase text-sub-title-16" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
											<p class="text-sub-title-10 fonteBranca">(Inscrições abertas)</p>
										</a>-->
									<?php else : ?>										
										<a class="raleway-bold btn btn-blue btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" href="cursos/lista-espera/<?= $curso['CURCODIGO']; ?>"   style="background-color: #f59330" role="button">Inscreva-se Aqui</a>
									<?php endif; ?>
								<?php else : ?>
									<a class="raleway-bold btn btn-block rounded-0 button-link bg-orange-theme text-white-theme text-uppercase text-sub-title-16 " href="identificacao-acesso/<?= $curso['CURCODIGO']; ?>"  style="background-color: #f59330" role="button">Inscreva-se Aqui</a>
								<?php endif; ?>
							<?php endif; ?>
							<?php if ($curso['INSCRICOESEADATIVA'] == 'true') : ?>
								<?php if ($curso['CURAOVIVO'] == 'false') : ?>
					...
					<div class="curso-site-banner">
						...
						<a href="restaurantes-conveniados">
							<img id="banner-chamada-1" class="img-fluid mx-auto d-block" src="./imgs/restaurantes-conveniados.png" style="border-top: none !important; border-bottom: none" alt="">
						</a>
				...
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<div class="row" style="background-color: #00548E">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-10 py-10 text-left">
							<span class="roboto-medium text-uppercase text-sub-title-20" style="color: #FFFFFF"><?= $curso['CURTITULOSITE']; ?></span>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-0 py-0 bg-beige-theme mt-1 pb-3">
							<div class="info-section">
								...
								<?php if ($curso['INSCRICOESEADATIVA'] == 'false') : ?>
									<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
										<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
											<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
											<a class="raleway-bold btn btn-accept btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
												<p class="text-sub-title-10 fonteBranca">(Inscrições abertas)</p><br>
											</a>
										<?php else : ?>
											<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
											<a class="raleway-bold btn btn-blue btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" href="cursos/lista-espera/<?= $curso['CURCODIGO']; ?>" style="background-color: #6f737e !important;">Lista de espera</a>
								...
								<?php if ($curso['INSCRICOESEADATIVA'] == 'true') : ?>
									...
									<?php if ($curso['CURAOVIVO'] == 'true') : ?>
										<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
											<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
												<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
												<a style="color: white" class="raleway-bold btn btn-accept btn-sm rounded-0 mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
													<p class="text-sub-title-10" style="font-size: 10px; color: white">(Inscrições abertas)</p>
												</a>
											<?php else : ?>
												<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
					...
					<div class="row">
						<?php foreach ($instrutor as $curso) :
							$lattes       = findLattesByNomeDocente($curso['INSNOME']);
						?>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-0 py-0 bg-beige-theme mt-1 pb-3">
										...
										<div class="col-12">
											<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 float-left d-block pl-4 pr-4 pb-1 pt-0">
												<p class="d-block roboto-regular text-sub-title-16 text-justify">
													<span class="roboto-bold"><?= $curso['INSNOME']; ?></span> - <?= $curso['INSCARGO']; ?>
												</p>
											</div>
											<div class="img-shadow col-xs-12 col-sm-12 col-md-12 col-lg-3 float-left text-center">
												<img src="https://www.dpmeducacao.com.br/app/ImagensInstrutores/<?= $curso['INSFOTO']; ?>" alt="" width="140" height="140">
											</div>
										</div>
									</div>
									<div class="biography">
										<img src="./icons-svg/icon-latus.svg" width="120">
										<a class="roboto-regular text-orange-theme link-orange" href="<?= $lattes['CODLINK']; ?>" target="_blanc" style="text-decoration:none;"><?= $lattes['CODLINK']; ?></a>
									</div>
								</div>
							</div>
						<?php endforeach; ?>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bg-beige-theme px-0 py-0 mt-1">
							<div class="section-instrucoes">
								...
								<div class="row">
									<div class="col-12">
										<?php if ($curso2['INSCRICOESEADATIVA'] == 'false') : ?>
											<?php if ($curso2['CURVAGAS'] - $curso2['CURMATRICULADOS'] <= 0) : ?>
												<?php if ($curso2['CURNOVATURMA'] === 'S') : ?>
													<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
													<a class="raleway-bold btn btn-accept btn-sm rounded-0 mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso2['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
														<p class="text-sub-title-10 fonteBranca">(Inscrições abertas)</p>
													</a>
												<?php else : ?>
													<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
													<a class="raleway-bold btn btn-blue btn-sm rounded-0 mt-1 text-uppercase text-sub-title-16" href="cursos/lista-espera/<?= $curso2['CURCODIGO']; ?>" style="background-color: #6f737e !important;">Lista de espera</a>
												<?php endif; ?>
											<?php else : ?>
												<a class="raleway-bold btn btn-block rounded-0 button-link bg-orange-theme text-white-theme text-uppercase text-sub-title-16  mb-1" href="identificacao-acesso/<?= $curso2['CURCODIGO']; ?>" role="button">Inscreva-se</a>
											<?php endif; ?>
										<?php endif; ?>
										<?php if ($curso2['INSCRICOESEADATIVA'] == 'true') : ?>
											<?php if ($curso2['CURAOVIVO'] == 'false') : ?>
												<a class="raleway-bold btn btn-block rounded-0 button-link bg-orange-theme text-white-theme text-uppercase text-sub-title-16  mb-1" href="identificacao-acesso/<?= $curso2['CURCODIGO']; ?>" role="button">Inscreva-se</a>
											<?php endif; ?>
											<?php if ($curso2['CURAOVIVO'] == 'true') : ?>
												<?php if ($curso2['CURVAGAS'] - $curso2['CURMATRICULADOS'] <= 0) : ?>
													<?php if ($curso2['CURNOVATURMA'] === 'S') : ?>
														<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
														<a style="color: white" class="raleway-bold btn btn-accept btn-sm rounded-0  mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso2['CURVINCULOTREINAMENTO']; ?>" style="background-color: #5b88a5" role="button">Nova Turma </br>
															<p class="text-sub-title-10" style="font-size: 10px; color: white">(Inscrições abertas)</p>
														</a>
													<?php else : ?>
														<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0  mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
