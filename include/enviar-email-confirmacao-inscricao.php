...
function emailCabecalho($pSTitulo)
{
	...
	$vSTexto .= '<p>CANAIS DE COMUNICAÇÃO DA DPM EDUCAÇÃO</p>';
	$vSTexto .= '<p>Site: <a href="https://dpmeducacao.com.br">https://dpmeducacao.com.br</a></p>';
	$vSTexto .= '<p>Telefone: '. cSTelefone1 . ' </p>';
	$vSTexto .= '<p> WhatsApp: '. cSTelefone2 . ' - ' . cSTelefone3 . '</p>';
	$vSTexto .= '<p> E-mail: '. vSEmailSite . '</p>';
	$vSTexto .= '</th>';
	$vSTexto .= '</tr>';
	$vSTexto .= '</thead>';
	$vSTexto .= '<tbody>';
