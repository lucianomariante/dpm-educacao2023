...
// ob_start();
#
envioEmailInscricao('TESTE UBISTART','testando msg','ronerhenry@gmail.com','roner rodrigues');
#
...
function envioEmailInscricao($pSTitulo, $pSMensagem, $pSAddAddress, $pSNomeAddAddress)
{
	...
	try {
		...
		// $mail->addCC('martina@dpmeducacao.com.br', 'DPM Educação');
		...
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = 'tls';
		$mail->Username = 'AKIASS2ZB7XHGZ7RJMLK';
		$mail->Password = 'BN/lXNWFrTY6sxbXRvx7mjY0QgcG4QxVXDLJTBEq31HS';
		$mail->setFrom('sistema@borbapauseperin.adv.br', 'TESTE INTEGRACAO 1');
		$mail->addAddress($pSAddAddress,$pSNomeAddAddress);
