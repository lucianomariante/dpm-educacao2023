						...
						<?php if ($curso['INSCRICOESEADATIVA'] == 'false') : ?>
							<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
								<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
									<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
							...
							<div class="info-section">
								...
								<?php if ($curso['INSCRICOESEADATIVA'] == 'false') : ?>
									<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
										<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
											<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
											<a class="raleway-bold btn btn-accept btn-sm rounded-0 transition-color mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>" role="button">Nova Turma </br>
								...
								<?php if ($curso['INSCRICOESEADATIVA'] == 'true') : ?>
									...
									<?php if ($curso['CURAOVIVO'] == 'true') : ?>
										<?php if ($curso['CURVAGAS'] - $curso['CURMATRICULADOS'] <= 0) : ?>
											<?php if ($curso['CURNOVATURMA'] === 'S') : ?>
												<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
												<a style="color: white" class="raleway-bold btn btn-accept btn-sm rounded-0 transition-color mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso['CURVINCULOTREINAMENTO']; ?>" role="button">Nova Turma </br>
													<p class="text-sub-title-10" style="font-size: 10px; color: white">(Inscrições abertas)</p>
												</a>
											<?php else : ?>
												<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
									...
									<div class="clearfix">
										...
										<div class="col-12">
											...
											<div class="img-shadow col-xs-12 col-sm-12 col-md-12 col-lg-3 float-left text-center">
												<img src="https://educacao.dpm-rs.com.br//ImagensInstrutores/<?= $curso['INSFOTO']; ?>" alt="" width="140" height="140">
											</div>
										</div>
									</div>
									<div class="biography">
										...
										<?php if ($curso2['INSCRICOESEADATIVA'] == 'false') : ?>
											<?php if ($curso2['CURVAGAS'] - $curso2['CURMATRICULADOS'] <= 0) : ?>
												<?php if ($curso2['CURNOVATURMA'] === 'S') : ?>
													<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
													<a class="raleway-bold btn btn-accept btn-sm rounded-0 transition-color mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso2['CURVINCULOTREINAMENTO']; ?>" role="button">Nova Turma </br>
														<p class="text-sub-title-10 fonteBranca">(Inscrições abertas)</p>
													</a>
												<?php else : ?>
													<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
													<a class="raleway-bold btn btn-blue btn-sm rounded-0 transition-color mt-1 text-uppercase text-sub-title-16" href="cursos/lista-espera/<?= $curso2['CURCODIGO']; ?>" role="button">Lista de espera</a>
												<?php endif; ?>
											<?php else : ?>
												<a class="raleway-bold btn btn-block rounded-0 button-link bg-orange-theme text-white-theme text-uppercase text-sub-title-16 transition-color mb-1" href="identificacao-acesso/<?= $curso2['CURCODIGO']; ?>" role="button">Inscreva-se</a>
											<?php endif; ?>
										<?php endif; ?>
										<?php if ($curso2['INSCRICOESEADATIVA'] == 'true') : ?>
											...
											<?php if ($curso2['CURAOVIVO'] == 'true') : ?>
												<?php if ($curso2['CURVAGAS'] - $curso2['CURMATRICULADOS'] <= 0) : ?>
													<?php if ($curso2['CURNOVATURMA'] === 'S') : ?>
														<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
														<a style="color: white" class="raleway-bold btn btn-accept btn-sm rounded-0 transition-color mt-1 text-uppercase text-sub-title-16" style="height: 37px !important;" href="cursos/<?= $curso2['CURVINCULOTREINAMENTO']; ?>" role="button">Nova Turma </br>
															<p class="text-sub-title-10" style="font-size: 10px; color: white">(Inscrições abertas)</p>
														</a>
													<?php else : ?>
														<a class="roboto-bold btn btn-danger text-uppercase btn-block rounded-0 transition-color mt-1 text-sub-title-16 fonteBranca" role="button">lotado</a>
