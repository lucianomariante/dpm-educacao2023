          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-0 py-0 bg-beige-theme mt-1">
              <div class="section-investimento">
                <div class="info-section-data"> <img class="img-fluid" src="./icons-svg/icon-investimento.svg" alt=""> <span id="investimento" class="roboto-bold-italic text-orange-theme">Investimento</span> </div>
                
                  
                  <div class="table-responsive table-responsive-sm table-responsive-md table-bordered mt-1" style="color: black; margin-bottom: 30px">
                  <table class="table">
                    <thead>
                      <tr class="bg-orange-theme text-center">
                        <th class="text-white-theme roboto text-sub-title-19" colspan="2" scope="col">Entes <span class="roboto-black text-white-theme">COM</span> contrato de consultoria com a Borba, Pause & Perin - Advogados</th>
                      </tr>
                    </thead>
                    <tbody style="font-size: roboto-condensed" class="tabelas-investimento">
                      <tr style="background-color: #cfcfcf">
                        <td width="65%" colspan="1">Valores para pagamento <strong><u>JUNTAMENTE COM A MENSALIDADE</u></strong><u></u></td>
                        <td width="35%" style="font-size: 15px"><strong>VALOR BRUTO PARA EMPENHO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td width="35%"><span style="font-size: 18px; font-weight: 700; color: black">R$ 452,00</span>
                          por participante </td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 ou mais inscritos</td>
                        <td><span style="font-size: 18px; font-weight: 700; color: black">R$ 406,00</span>
                          por participante</td>
                      </tr>
                      <tr style="background-color: #cfcfcf">
                        <td colspan="1">Valores para pagamento <strong><u>ANTECIPADO C/ DESCONTO</u></strong> somente por transferência/PIX do evento (sem emissão de boleto)</td>
                        <td style="font-size: 15px"><strong>VALOR BRUTO PARA EMPENHO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td><span style="font-size: 18px; font-weight: 700; color: black">R$ 406,00</span>
                      ...
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 a ou mais participantes</span></td>
                        <td><span style="font-size: 18px; font-weight: 700; color: black">R$ 406,00</span>
                          por participante</td>
                      </tr>
                    </tbody>
                ...
                <div class="table-responsive table-responsive-sm table-responsive-md table-bordered mt-1" style="color: black; margin-bottom: 30px">
                  <table class="table">
                    <thead>
                      <tr class="bg-orange-theme text-center">
                        <th class="text-white-theme roboto text-sub-title-19" colspan="2" scope="col">Entes <span class="roboto-black text-white-theme">SEM</span> contrato de consultoria com a Borba, Pause & Perin - Advogados</th>
                      </tr>
                    </thead>
                    <tbody style="font-size: roboto-condensed" class="tabelas-investimento">
                      <tr style="background-color: #cfcfcf">
                        <td width="65%" colspan="1">Valores para pagamento <strong><u>ANTECIPADO COM DESCONTO</u></strong><u></u></td>
                        <td width="35%" style="font-size: 15px"><strong>VALOR BRUTO PARA EMPENHO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td width="30%"><span style="font-size: 18px; font-weight: 700; color: black">R$ 452,00</span>
                          por participante </td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 a ou mais participantes</td>
                        <td><span style="font-size: 18px; font-weight: 700; color: black">R$ 406,00</span>
                          por participante</td>
                      </tr>
                      <tr style="background-color: #cfcfcf">
                        <td colspan="1">Valores para pagamento <strong><u>POR BOLETO BANCÁRIO</u></strong> somente por transferência/PIX do evento (sem emissão de boleto)</td>
                        <td style="font-size: 15px"><strong>VALOR BRUTO PARA EMPENHO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td><span style="font-size: 18px; font-weight: 700; color: black">R$ xxx</span>
                          por participante</td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 a ou mais participantes</span></td>
                 ...
                 <div class="text-center p-3"><img src="imgs/atencao.png" width="500px" alt=""/></div>
                                    <a href="#" class="large-view roboto-regular text-sub-title-21 btn btn-primary btn-sm btn-block rounded-0 transition-color mt-4" role="button" aria-pressed="true">Dados para empenho: DPM Educação Ltda., CNPJ 13.021.017/0001-77</a> <a href="#" class="mobile-view roboto-regular text-sub-title-19 btn btn-primary btn-sm btn-block rounded-0 transition-color mt-4" role="button" aria-pressed="true">Dados para empenho: </br>
                DPM Educação Ltda., </br>
                CNPJ 13.021.017/0001-77</a> 
                </div>
                  
               <div class="table-responsive table-responsive-sm table-responsive-md table-bordered mt-1" style="color: black; margin-bottom:">
                  <table class="table">
                    <thead>
                      <tr class="bg-orange-theme text-center">
                        <th class="text-white-theme roboto text-sub-title-19" colspan="2" scope="col">Demais Interessados</th>
                      </tr>
                    </thead>
                    <tbody style="font-size: roboto-condensed" class="tabelas-investimento">
                      <tr style="background-color: #cfcfcf">
                        <td width="65%" colspan="1">Valores para pagamento <strong><u>POR TRANSFERÊNCIA OU PIX</u></strong><u></u></td>
                        <td width="35%" style="font-size: 15px"><strong>VALOR BRUTO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td width="35%"><span style="font-size: 18px; font-weight: 700; color: black">R$ xxx</span>
                          por participante </td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 a ou mais participantes</td>
                      ...
                      <tr style="background-color: #cfcfcf">
                        <td colspan="1">Valores para pagamento <strong><u>POR BOLETO BANCÁRIO</u></strong></td>
                        <td style="font-size: 15px"><strong>VALOR BRUTO</strong></td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes02.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">01 a 02 participantes</span></td>
                        <td width="40%"><span style="font-size: 18px; font-weight: 700; color: black">R$ xxx</span>
                          por participante </td>
                      </tr>
                      <tr>
                        <td colspan="1"><img src="imgs/participantes03.png" width="90px" style="margin-left: 10px" alt=""/><span style="padding: 0px 10px; font-size: 20px; font-weight: 700; color: black">03 a ou mais participantes</td>
            ...
            <div class="row text-center">
              <div class="col-12 bg-orange-theme text-white-theme roboto text-sub-title-19" style="padding: 8px;">Dados Bancários</div>
                <div class="col-12 p-2"><img src="imgs/dados-bancarios.png" width="90%" alt=""/></div>
