...
if (isset($_POST['BTEnvia'])) {
 ...
 $email_reply = "$email";
 $email_assunto = "Contato Interesse EAD Dispensa Licitação"; // Este será o assunto da mensagem
 //====================================================
                                   ...
                                   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-0 mt-0">
                                       <div class="cursos-in-company" id="formContato" name="formContato">
                                             ...
                                             div class="col-12 pt-0 pb-3 pl-0">
                                                 <div class="form-group row">
                                                     <div class="col-xs-4 col-sm-12 col-md-11 col-lg-11 pt-0 pb-0">
                                                       <input style="border-radius: 0; height:45px;" type="text" size="35" name="whatsapp" class="form-control lg-input ml-3 mr-3"  placeholder="WhatsApp opcional - com DDD:">
                                                     </div>
                                                 </div>
                                             </div>
