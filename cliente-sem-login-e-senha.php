                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-0 pb-0">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-9 pr-0">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3">
                                                <button id="btnCnpj" class="roboto-bold text-white btn" role="button" style="background-color: #01548e; font-size: 15px;">
                                    ...
                                    <div class="col-xs-4 col-sm-12 col-md-12 col-lg-12 pt-0 pb-0 pl-0">
                                        <div class="form-group row">
                                            <div class="col-xs-4 col-sm-12 col-md-12 col-lg-12 pt-0 pb-0 text-line-height-2">
                                                ...
                                                <input id="vSALUPCD" name="vSALUPCD" type="text" class="form-control lg-input ml-3 mr-3" placeholder="Se for Portador de Necessidades Especiais Informe Aqui!">
                                            </div>
                                        </div>
                                    </div>
                                    <!--<div class="col-xs-4 col-sm-12 col-md-12 col-lg-12 pt-0 pb-0 pl-0">
