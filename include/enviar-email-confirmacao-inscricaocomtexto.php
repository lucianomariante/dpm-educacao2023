<?php
ob_start();
require_once __DIR__ . DIRECTORY_SEPARATOR . 'constantes.php';
ob_end_clean();
...
// envioEmailInscricao('teste', 'teste', 'ronerhenry@gmail.com', 'teste');
...
function inscricaoFinalizada($dados, $pSFormaPgto)
{
	...
	$vSTexto .= 'REGISTRAMOS QUE, UMA VEZ FEITA A INSCRIÇÃO, PARA EFEITOS DE COBRANÇA, SOMENTE SERÁ CONSIDERADO O CANCELAMENTO FEITO COM ANTECEDÊNCIA MÍNIMA DE 04 (QUATRO) DIAS ÚTEIS DA DATA DO INÍCIO DO CURSO.
...
<p>Informações:Telefone (51) 3094-3440, whatsapp (51) 98041-5821, e-mail <a href="cursos@dpmeducacao.com.br" title="Cursos">cursos@dpmeducacao.com.br</a> ou chat online, de segunda a sexta-feira, no horário das 09h às 17h.
<p>ATENÇÃO: Este é um e-mail automático, dúvidas contatar pelo e-mail indicado acima.</p>';
	$vSTexto .= '</tr>';
	$vSTexto .= '</tbody>';
	$vSTexto .= '</table>';
