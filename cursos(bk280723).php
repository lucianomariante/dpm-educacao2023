                  ...
                  <div class="col-md-3" style="display: flex">
                    <div class="blog-grid-simple" style="margin: 0 0 0px 0; min-height: 295px; border: solid 1.5px #dedede;">
                      <div style="display: flex">
                        ...
                        <div><span class="curso-modalidade" style="background-color:<?= $item['cormodalidade']; ?>;"><?= $item['modalidade']; ?></span></div>
                      </div>
                      <div class="courses-grid-content">
                      <h4 title="<?= $item['CURTITULOSITE']; ?>"> <a href="https:/cursos/<?= $item['CURCODIGO']; ?>" target="_blank"> <?= $item['CURTITULOSITE']; ?></a></h4>
                        <div class="" style="font-size: 12px; padding: 5px 0;margin-top: 15px; margin-bottom: 30px; border-top: solid 1px #e6e6e6"><i class="fas fa-map-marker-alt"></i><b> <?=  $cidadeCur; ?></b></div>
                        ...
                        <?php if ($item['CURVAGAS'] - $item['CURMATRICULADOS'] <= 0) : ?>
                          ...
                          <button style="width: 100%; font-size: 12px; margin: 0 0 4px 0" class="btn btn-info"  style="background-color: #6f737e !important;" role="button"><a href="/cursos/lista-espera/<?= $item['CURCODIGO']; ?>">LISTA DE ESPERA</a></button>
														<?php endif; ?>
														<?php if ($item['CURVAGAS'] - $item['CURMATRICULADOS'] > 0) : ?>
															<button style="width: 100%; font-size: 12px; margin: 0 0 4px 0" class="btn btn-primary"  style="background-color: #f59330" role="button"><a href="/cursos/<?= $item['CURCODIGO']; ?>">INSCREVA-SE</a></button>
														<?php endif; ?>
														<?php if ($item['CURNOVATURMA'] == 'S') : ?>
															<button style="width: 100%; font-size: 12px; margin: 0 0 4px 0" class="btn btn-primary"  style="background-color: #5b88a5" role="button"><a href="/cursos/<?= $item['CURVINCULOTREINAMENTO']; ?>">NOVA TURMA<BR> (INSCRIÇÕES ABERTAS)</br></a></button>
														<?php endif; ?>
														<button style="width: 100%;
    font-size: 12px;
    margin: 0 0 4px 0;
    background-color: #8e8e8e;
    color: white;" class="btn btn-gray"   style="background-color: #045071" role="button"><a href="/cursos/<?= $item['CURCODIGO']; ?>"> SOBRE O CURSO</a></button>
													</div>
                    </div>
                  </div>
                  <?php endforeach; ?>
